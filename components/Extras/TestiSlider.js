  ...
  return (
    <div className="my-16 overflow-hidden">
      <div className={classes.imagecontainer}>
        <div className="flex gap-14 w-8/12 bg-slate-50 rounded-3xl px-4 pt-6 pb-6 overflow-hidden">
          <Image
            src={c1}
        ...
        <div className="flex gap-14 w-8/12 bg-slate-50 rounded-3xl px-4 pt-6 pb-6 overflow-hidden">
          ...
          <div className="flex justify-center items-center">
            <p className="italic font-semibold text-xl text-center w-10/12">
              “Automating all my business operations with this software has been
              a game changer. It is user-friendly and incredibly effective.”
            </p>
            </div>
            <div className="flex justify-between">
              <div>
